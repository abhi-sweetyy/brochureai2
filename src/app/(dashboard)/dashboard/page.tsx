...
const getFormSteps = (t: any) => [
  ...
  {
    title: t("formSteps.commission.title"),
    description: t("formSteps.commission.description"),
  },
  {
...
const Dashboard = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      (Object.entries(selectedPages) as [PageId, boolean][]).forEach(
        ([pageId, isSelected]) => {
      ...
      if (objectType === "family_house") {
        transformedPlaceholders.customp1 =
          ...
          ) || "Grundstücksgröße (m²)"; // Always German
