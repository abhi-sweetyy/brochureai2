    ...
    const fetchProject = async (currentSession: Session | null) => {
      ...
      try {
        ...
        const focusedDetails: Project['project_details'] = {
          ...
          broker_name: existingDetails.broker_name || '',
        };
        ...
        setPlaceholders({
          ...
          'broker_name': focusedDetails.broker_name || '',
        });
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      const updatedProjectDetails = {
        ...
        broker_name: projectDetails.broker_name,
      };
                    ...
                    <div className="space-y-6">
                      ...
                      <div>
                        <label htmlFor="broker_name" className="block text-sm font-medium text-gray-700 mb-1">
                          {t('project.brokerName')}
                        </label>
                        <input
                          type="text"
                          id="broker_name"
                          name="broker_name"
                          value={projectDetails.broker_name || ''}
                          onChange={handleInputChange}
                          className="w-full bg-white border border-gray-300 rounded-lg px-4 py-2 text-gray-800 focus:ring-1 focus:ring-blue-500 focus:border-blue-500"
                        />
                      </div>
