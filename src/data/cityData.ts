...
export const cities: { [key: string]: CityData } = {
  ...
  "Ulm": {
    text1: "Ulm liegt im Osten Baden-Württembergs an der Donau und hat rund 127.000 Einwohner. Gemeinsam mit der bayerischen Nachbarstadt Neu-Ulm bildet Ulm ein grenzübergreifendes Doppelzentrum mit insgesamt etwa 180.000 Menschen. Die Stadt ist Sitz mehrerer Gerichte, Behörden sowie einer Universität und Hochschule. Sie gilt als Oberzentrum der Region Donau-Iller und ist ein bedeutender Standort für Wissenschaft, Forschung und Verwaltung. Wirtschaftlich ist Ulm geprägt durch eine starke Industrie, unter anderem in den Bereichen Maschinenbau, Pharmazie und Elektronik. Unternehmen wie die Wieland-Werke oder die Daimler AG betreiben hier wichtige Standorte. Das Stadtbild ist bekannt für das imposante gotische Ulmer Münster mit dem höchsten Kirchturm der Welt. Daneben prägen Fachwerkhäuser, moderne Architektur, die Donauauen sowie das historische Fischerviertel das Stadtbild.",
  ...
  "Tübingen": {
    text1: "Tübingen ist eine Universitätsstadt im Zentrum Baden-Württembergs mit rund 92.000 Einwohnern. Sie liegt am Neckar und zählt zu den jüngsten Städten Deutschlands – bedingt durch ihren hohen Studierendenanteil. Tübingen ist Sitz der Eberhard Karls Universität, einer der ältesten und renommiertesten Universitäten Europas, sowie zahlreicher Forschungsinstitute und Kliniken. Die Stadt ist ein bedeutender Wissenschaftsstandort. Die Wirtschaft ist geprägt durch Bildung, Forschung, Medizintechnik und Dienstleistungen. Viele Start-ups und innovative Unternehmen sind eng mit der Universität verknüpft. Das Stadtbild ist von der historischen Altstadt, dem Schloss Hohentübingen, dem Neckarufer und zahlreichen Grünflächen geprägt. Die Mischung aus Tradition, studentischem Leben und Natur macht den Reiz der Stadt aus.",
