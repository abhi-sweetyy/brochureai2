  ...
  const getImageSections = () => {
    ...
    sections.push(
      <div key="logo" className="mb-8">
        <h3 className="text-lg font-semibold text-gray-900 mb-2">{t('imagesStep.companyLogo')}</h3>
    ...
    sections.push(
      <div key="agent" className="mb-8">
        <h3 className="text-lg font-semibold text-gray-900 mb-2">{t('imagesStep.agentPhoto')}</h3>
    ...
    if (selectedPages.projectOverview) {
      sections.push(
        <div key="overview" className="mb-8">
          <h3 className="text-lg font-semibold text-gray-900 mb-2">{t('imagesStep.projectOverview')}</h3>
          <p className="text-gray-700 mb-4">{t('imagesStep.projectOverviewDesc')}</p>
          <ImageUploader
    ...
    if (selectedPages.buildingLayout) {
      sections.push(
        <div key="layout" className="mb-8">
          <h3 className="text-lg font-semibold text-gray-900 mb-2">{t('imagesStep.buildingLayout')}</h3>
          <p className="text-gray-700 mb-4">{t('imagesStep.buildingLayoutDesc')}</p>
          <ImageUploader
    ...
    if (selectedPages.exteriorPhotos) {
      sections.push(
        <div key="exterior" className="mb-8">
          <h3 className="text-lg font-semibold text-gray-900 mb-2">{t('imagesStep.exteriorPhotos')}</h3>
          <p className="text-gray-700 mb-4">{t('imagesStep.exteriorPhotosDesc')}</p>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              <p className="text-sm text-gray-700 mb-2">{t('imagesStep.exteriorPhoto1')}</p>
              <ImageUploader
            ...
            <div>
              <p className="text-sm text-gray-700 mb-2">{t('imagesStep.exteriorPhoto2')}</p>
              <ImageUploader
    ...
    if (selectedPages.interiorPhotos) {
      sections.push(
        <div key="interior" className="mb-8">
          <h3 className="text-lg font-semibold text-gray-900 mb-2">{t('imagesStep.interiorPhotos')}</h3>
          <p className="text-gray-700 mb-4">{t('imagesStep.interiorPhotosDesc')}</p>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              <p className="text-sm text-gray-700 mb-2">{t('imagesStep.interiorPhoto1')}</p>
              <ImageUploader
            ...
            <div>
              <p className="text-sm text-gray-700 mb-2">{t('imagesStep.interiorPhoto2')}</p>
              <ImageUploader
    ...
    if (selectedPages.floorPlan) {
      sections.push(
        <div key="floorplan" className="mb-8">
          <h3 className="text-lg font-semibold text-gray-900 mb-2">{t('imagesStep.floorPlan')}</h3>
    ...
    if (selectedPages.energyCertificate) {
      sections.push(
        <div key="energy" className="mb-8">
          <h3 className="text-lg font-semibold text-gray-900 mb-2">{t('imagesStep.energyCertificate')}</h3>
          <p className="text-gray-700 mb-4">{t('imagesStep.energyCertificateDesc')}</p>
          <div>
            <p className="text-sm text-gray-700 mb-2">{t('imagesStep.energyPage1')}</p>
            <ImageUploader
